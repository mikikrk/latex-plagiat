package pl.edu.agh.kiro.latex_plagiat.client.model.core;
...
import pl.edu.agh.kiro.latex_plagiat.commons.util.Observable;
...
public class Client extends Observable implements Observer {
    ...
    private pl.edu.agh.kiro.latex_plagiat.client.model.io.ClientReader reader;
    private ClientWriter writer;
    private ExecutorService executorService = Executors.newFixedThreadPool(2);
    private CyclicBarrier cyclicBarrier = new CyclicBarrier(2);
    private boolean waitForResponse;

    public Client(Socket socket, pl.edu.agh.kiro.latex_plagiat.client.model.io.ClientReader reader, ClientWriter writer) {
        this.socket = socket;
        this.reader = reader;
        this.writer = writer;
    }
